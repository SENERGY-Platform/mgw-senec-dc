...
from util import MQTTClient, SenecDevice, get_logger, conf
...
class DeviceManager(threading.Thread):
    def __init__(self, mqtt_client: MQTTClient):
        ...
        self._devices: Dict[str, SenecDevice] = {}

    def is_device_id_known(self, device_id: str):
        return device_id in self._devices

    def handle_new_device(self, device: SenecDevice):
        try:
    ...
    def handle_missing_device(self, device: SenecDevice):
    ...
    def handle_existing_device(self, device: SenecDevice):
        try:
    ...
    def get_devices(self) -> Dict[str, SenecDevice]:
        return self._devices

    def set_devices(self, devices: Dict[str, SenecDevice]):
